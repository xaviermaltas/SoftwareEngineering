...
**
** Created: Sat May 30 12:31:22 2015
...
static const char qt_meta_stringdata_View[] = {
    "View\0\0locationDetails,event\0"
    "update(std::string,std::string)\0"
};
...
void View::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->update((*reinterpret_cast< const std::string(*)>(_a[1])),(*reinterpret_cast< const std::string(*)>(_a[2]))); break;
        default: ;
        }
    }
}
