...
static const char qt_meta_stringdata_Model[] = {
    "Model\0\0locationDetails,event\0"
    "modify(std::string,std::string)\0"
    "direction\0doMove(std::string)\0itemName\0"
    "doUseItem(std::string)\0"
};
...
void Model::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->modify((*reinterpret_cast< const std::string(*)>(_a[1])),(*reinterpret_cast< const std::string(*)>(_a[2]))); break;
        case 1: _t->doMove((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        case 2: _t->doUseItem((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void Model::modify(const std::string & _t1, const std::string & _t2)
{
